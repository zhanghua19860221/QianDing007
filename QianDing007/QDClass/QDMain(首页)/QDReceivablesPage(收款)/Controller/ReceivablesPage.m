...
- (void)getDateSource{
    ...
    [[shareDelegate shareAFHTTPSessionManager] POST:[shareDelegate stringBuilder:HOME_URL] parameters:rootDic progress:^(NSProgress * _Nonnull uploadProgress) {
...
// 商户信息视图填充网络数据
    ...
    [mebInfoView layoutIfNeeded];
    rp_telePhone.text = tempStr;
