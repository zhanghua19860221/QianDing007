...
- (void)submitBtnClick:(UIButton *)btn{
    ...
    [[shareDelegate shareAFHTTPSessionManager] POST:[shareDelegate stringBuilder:MODIFY_PHONE_URL] parameters:nctDic progress:^(NSProgress * _Nonnull uploadProgress) {
