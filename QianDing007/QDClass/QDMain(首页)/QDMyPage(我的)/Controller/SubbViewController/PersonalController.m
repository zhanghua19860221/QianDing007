...
- (void)psSubmitBtnClick:(UIButton *)btn{
    ...
    [[shareDelegate shareAFHTTPSessionManager] POST:[shareDelegate stringBuilder:SAVEINFOUSER_URL] parameters:personalDic constructingBodyWithBlock:^(id<AFMultipartFormData> _Nonnull formData) {
