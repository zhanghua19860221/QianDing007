...
-(void)upGetDataSource{
    ...
    [[shareDelegate shareAFHTTPSessionManager] POST:[shareDelegate stringBuilder:urlStr] parameters:pcDic progress:^(NSProgress * _Nonnull uploadProgress) {
...
- (void)updateData{
    ...
    [[shareDelegate shareAFHTTPSessionManager] POST:[shareDelegate stringBuilder:urlStr] parameters:gpDic progress:^(NSProgress * _Nonnull uploadProgress) {
