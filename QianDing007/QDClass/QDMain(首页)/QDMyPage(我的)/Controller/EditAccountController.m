...
- (void)eaGetDateSource{
    ...
    [[shareDelegate shareAFHTTPSessionManager] POST:[shareDelegate stringBuilder:GETBANKINFO_URL] parameters:paDic progress:^(NSProgress * _Nonnull uploadProgress) {
...
- (void)writeCompletion{
    ...
    [[shareDelegate shareAFHTTPSessionManager] POST:[shareDelegate stringBuilder:SAVESETBANKINFO_URL] parameters:saDic progress:^(NSProgress * _Nonnull uploadProgress) {
