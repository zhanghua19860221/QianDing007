...
-(void)rlSubmitBtnClick:(UIButton*)btn{
    ...
    [[shareDelegate shareAFHTTPSessionManager] POST:[shareDelegate stringBuilder:REGISTERTHIRDLOGIN_URL] parameters:rlDic progress:^(NSProgress * _Nonnull uploadProgress) {
